...
win_serve <- c('w_ace', 'w_df', 'w_svpt', 'w_1stIn', 'w_1stWon',
       'w_2ndWon', 'w_SvGms', 'w_bpconv')
lose_serve <- c('l_ace', 'l_df',
       'l_svpt', 'l_1stIn', 'l_1stWon', 'l_2ndWon', 'l_SvGms', 'l_bpconv')
```
...
evol
plot(evol$year,evol$w_1stserve, type = 'b', cex = 0.9, pch = 19, col = 'darkgreen', ylab = '% of points won on the 1st serve',
     xlab = 'Year', main = 'Has the serve become more important?', ylim = c(50,80))
plot(evol$year,evol$w_2ndserve, type = 'b')
